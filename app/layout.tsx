...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html
      ...
      className={`${geist.variable} ${jetbrainsMono.variable} scroll-smooth`}
    ...
    >
      ...
      <body className="bg-[oklch(0.968_0.005_80)] pl-[calc(100vw-100%)] text-[#1a1814] antialiased dark:bg-[#111110] dark:text-[#e8e6e1]">
        <ThemeProviders>
